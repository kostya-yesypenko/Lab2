...
def main():
    Kostia = Student("Kostia", "Yesypenko", math=5, literature=5)
    Vlad = Student("Vladislav", "Poliak", math=3, literature=3)

    Vlad.add_grade("economy", 4)
    Vlad.change_grade("math", 2)

    group = Group(Kostia, Vlad)
